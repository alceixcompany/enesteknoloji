...
import { checkDatabaseAdmins, clearError, loginUser } from '@/store/slices/authSlice';
        ...
        >
          <section className="relative hidden min-h-[720px] overflow-hidden lg:block">
            ...
            <div className="absolute inset-x-0 bottom-0 p-12 text-white">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[var(--lale-gold-soft)]">ENES TEKNOLOJİ YÖNETİM</p>
          ...
          <section className="flex min-h-[660px] flex-col justify-center px-6 py-10 sm:px-12 lg:px-14">
            ...
            <div className="mt-12">
              <div className="inline-flex items-center justify-center rounded-[22px] bg-white p-4 text-[var(--ink)] shadow-xl">
                <BrandMark dark />
              </div>
              ...
              <p className="mt-3 text-sm leading-7 text-white/55">Enes Teknoloji yönetim paneline devam etmek için bilgilerinizi girin.</p>
            </div>
              ...
              <label className="block space-y-2">
                ...
                <span className="relative block">
                  ...
                  <input
                    ...
                    placeholder="admin@enesteknoloji.com"
                    disabled={isLoading}
                  />
                </span>
              </label>
            ...
            <p className="mt-10 text-center text-[10px] uppercase tracking-[0.18em] text-white/30">Enes Teknoloji · {new Date().getFullYear()}</p>
          </section>
        </motion.div>
      </div>
    </main>
