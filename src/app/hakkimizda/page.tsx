...
export default function AboutPage() {
  return <main className="bg-[var(--paper)] text-[var(--ink)]">
    <StorePageHero index="02" eyebrow="Hakkımızda" title="Güven, işimizin en önemli parçası." description="Enes Teknoloji; teknik bilgiyi açık iletişim, temiz işçilik ve satış sonrası destekle bir araya getirerek Türkiye'nin 81 iline hizmet verir." image="/images/edited/telefon-kilifi-duvari-02.webp" imageAlt="Enes Teknoloji telefon mağazası ve aksesuar bankosu" />
    ...
    <section className="px-5 py-20 sm:px-8 lg:px-12 lg:py-28"><div className="mx-auto grid max-w-[1440px] gap-14 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:gap-20">
      <div className="grid grid-cols-12 gap-4">
        <div className="relative col-span-12 min-h-[440px] overflow-hidden rounded-[32px] sm:col-span-9 sm:min-h-[580px]"><Image src="/images/edited/magaza-giris-01.webp" alt="Enes Teknoloji mağaza içi" fill className="object-cover object-center" sizes="(max-width:1024px) 100vw, 50vw"/><div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent"/></div>
        <div className="relative col-span-12 min-h-[260px] overflow-hidden rounded-[26px] sm:col-span-3 sm:mt-20 sm:min-h-0"><Image src="/images/edited/magaza-koridoru.webp" alt="Enes Teknoloji aksesuar alanı" fill className="object-cover" sizes="(max-width:640px) 100vw, 18vw"/></div>
      </div>
