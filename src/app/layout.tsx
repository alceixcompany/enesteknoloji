...
const localBusinessSchema = {
  ...
  image: `${siteUrl}/images/edited/magaza-genel-hero.webp`,
  telephone: '+90 536 527 81 75',
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'Merkez Mahallesi Soğanlı Caddesi No:80/C',
    addressLocality: 'Güngören',
    addressRegion: 'İstanbul',
    addressCountry: 'TR',
  },
  openingHours: 'Mo-Su 11:00-22:00',
  description: 'Türkiye’nin 81 iline hizmet veren cep telefonu teknik servisi; 30 dakikada ekran ve batarya değişimi, yazılım desteği ve telefon aksesuarları.',
  contactPoint: {
    '@type': 'ContactPoint',
    telephone: '+90 536 527 81 75',
...
export const metadata: Metadata = {
  ...
  description: "Türkiye’nin 81 iline hizmet; 30 dakikada ekran ve batarya değişimi, şarj, yazılım desteği ve telefon aksesuarları.",
  ...
  openGraph: {
    ...
    description: 'Türkiye’nin 81 iline hizmet, 30 dakikada ekran ve batarya değişimi, yazılım desteği ve aksesuar çözümleri.',
    images: [{ url: '/images/edited/magaza-genel-hero.webp', width: 1448, height: 1086, alt: 'Enes Teknoloji telefon mağazası ve teknik servis' }],
  },
  twitter: {
